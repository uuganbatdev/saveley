...
export default function TopDetail() {
  ...
  return (
    <div className="py-3 flex justify-between items-center text-white">
      <div className="w-10 h-10 bg-main/90 flex justify-center items-center text-xl  rounded-full">
        {appState.email[0].toUpperCase()}
      </div>
      <div className="flex space-x-3">
        ...
        <div className="px-2 py-1 text-sm bg-main/90 rounded-full flex items-center space-x-2">
          ...
          <div className='font-medium'>12000</div>
        </div>
      </div>
    </div>
  );
